...
const CreatePoint = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        const abbreviations = response.data.map((inicial) => inicial.sigla);
        setUfs(abbreviations);
      });
  }, []);
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    data.append("itemSelected", itemSelected.join(","));
    data.append("uf", uf);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <ul className="items-grid">
            {items.map((
              item // parêntese mesma coisa que return
            ) => (
              <li
                key={item.id}
